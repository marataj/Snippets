'''
Poniżej znajduje się definicja klasy z właściwością zdefiniowaną w
"standardowy" sposób. Zmień ją tak, żeby właściwości były definiowane
przy pomocy dekoratorów
'''
'''
Property tworzymy dla zmiennych protected, czyli rozpoczynajacych sie od dundera
'''
